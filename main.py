...
def generate16Bits(bit16 = 0b0):
    # This function exists to save my sanity
    ...
    # vs 0, 0, 1, 0...
    bits = [int(bit) for bit in bin(bit16)[2:]][::-1]
    for index, _ in enumerate(bits):
        two_bytes[index] = bits[index]
    return tuple(two_bytes)
...
def tupleToBinary(binary_tuple_16):
    b1  = binary_tuple_16[0]
    b2  = binary_tuple_16[1]
    b3  = binary_tuple_16[2]
    b4  = binary_tuple_16[3]
    b5  = binary_tuple_16[4]
    b6  = binary_tuple_16[5]
    b7  = binary_tuple_16[6]
    b8  = binary_tuple_16[7]
    b9  = binary_tuple_16[8]
    b10 = binary_tuple_16[9]
    b11 = binary_tuple_16[10]
    b12 = binary_tuple_16[11]
    b13 = binary_tuple_16[12]
    b14 = binary_tuple_16[13]
    b15 = binary_tuple_16[14]
    b16 = binary_tuple_16[15]
    return int(f"{b1}{b2}{b3}{b4}{b5}{b6}{b7}{b8}{b9}{b10}{b11}{b12}{b13}{b14}{b15}{b16}", 2)
...
class LogicGates16:
    ...
    def nand_gate(self, bits16_one, bits16_two):
        ...
        g1 = self.logic_gates.nand_gate(byte_one[0], byte_two[0])
        g2 = self.logic_gates.nand_gate(byte_one[1], byte_two[1])
        g3 = self.logic_gates.nand_gate(byte_one[2], byte_two[2])
        g4 = self.logic_gates.nand_gate(byte_one[3], byte_two[3])
        g5 = self.logic_gates.nand_gate(byte_one[4], byte_two[4])
        g6 = self.logic_gates.nand_gate(byte_one[5], byte_two[5])
        g7 = self.logic_gates.nand_gate(byte_one[6], byte_two[6])
        g8 = self.logic_gates.nand_gate(byte_one[7], byte_two[7])
        g9 = self.logic_gates.nand_gate(byte_one[8], byte_two[8])
        g10 = self.logic_gates.nand_gate(byte_one[9], byte_two[9])
        g11 = self.logic_gates.nand_gate(byte_one[10], byte_two[10])
        g12 = self.logic_gates.nand_gate(byte_one[11], byte_two[11])
        g13 = self.logic_gates.nand_gate(byte_one[12], byte_two[12])
        g14 = self.logic_gates.nand_gate(byte_one[13], byte_two[13])
        g15 = self.logic_gates.nand_gate(byte_one[14], byte_two[14])
        g16 = self.logic_gates.nand_gate(byte_one[15], byte_two[15])
